...
export default function Duration() {
  ...
  return (
    <section className="flex items-center justify-around gap-6 px-4 w-full overflow-x-hidden">
      ...
      <div className="w-full flex-grow-0 p-1 items-center font-biber grid grid-flow-col grid-cols-2 gap-1"  style={{fontSize:`70px`}}>
        <span  style={{fontSize:`70px`}} ref={count}>{duration}</span> <span className="text-[60px]">min</span>
      </div>
    </section>
  );
}
